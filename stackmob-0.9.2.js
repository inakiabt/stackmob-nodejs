/*
 ...
 limitations under the License.
  ...
  - Sep 14, 2013
   Modified stackmob-0.9.2 for support with NodeJS (using Surat Teerapittayanon's code as a template). I've added comments to each line(s) that I've changed with //Change to support nodejs
   Chris Tan
   Note: not fully tested. I am testing while I code a new StackMob project.
 */
...
(function() {
   ...
   */
   //Change to support nodejs //Note: I added this comment as a placeholder. Nothing was changed on this line
